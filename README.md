...
1. Cloner ce dépôt de code à l'aide de la commande `$ git clone https://github.com/pythonmentor/ocmovies-api.git` (vous pouvez également télécharger le code [en temps qu'archive zip](https://github.com/pythonmentor/ocmovies-api/archive/master.zip))
